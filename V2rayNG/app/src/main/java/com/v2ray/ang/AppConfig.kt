...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/waigyitinsein-code/VpnV2ray"
    const val APP_API_URL = "https://api.github.com/repos/waigyitinsein-code/VpnV2ray/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$GITHUB_URL/2dust/v2rayNG/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/waigyitinsein-code/VpnV2ray/main/CR.md"
